...
<div class="flex-1 flex flex-col items-center justify-center text-center px-4">
	...
	<h2 class="text-lg text-gray-700 max-w-xl mb-6">
		Vous pouvez consulter la liste des pokémons, consulter et configurer des équipes ainsi que
		visualiser les types disponibles.
	</h2>
